...
def runModel(img_width,img_height,train_data_dir,valid_data_dir,n_train_samples,n_valid_samples,epochs,batch_size,outputSize):
	...
	model.save('agromate.h5')

	#img_pred = image.load_img('data/train/orange/orange_1.jpg', target_size = (150,150))
...
runModel(img_width,img_height,train_data_dir,valid_data_dir,n_train_samples,n_valid_samples,epochs,batch_size,outputSize)
